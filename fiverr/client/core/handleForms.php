...
if (isset($_POST['insertOfferBtn'])) {
	...
	// Check if user has already submitted an offer for this proposal
	if ($offerObj->hasUserOfferedForProposal($user_id, $proposal_id)) {
	...
	// Create the offer if no duplicate exists
