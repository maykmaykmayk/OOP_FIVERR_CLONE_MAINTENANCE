                ...
                <div class="col-md-6">
                  <div class="card" style="height: 600px;">
                    ...
                    <div class="card-footer">
                      <?php 
                      // Check if current user has already submitted an offer for this proposal
                      $hasUserOffered = $offerObj->hasUserOfferedForProposal($_SESSION['user_id'], $proposal['proposal_id']);
                      ?>
                      <?php if ($hasUserOffered): ?>
                        <div class="alert alert-warning" role="alert">
                          <strong>You have already submitted an offer for this proposal!</strong>
                        </div>
                      <?php else: ?>
                        <form action="core/handleForms.php" method="POST">
                          <div class="form-group">
